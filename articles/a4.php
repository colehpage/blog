...
<p class="article-description">In this post I wanted to kill two birds with one stone. First, to test out my method for integrating my ipython notebook work into blog posts, and second to brush a little rust off my understanding of Convolutional Neural Nets. The other day I was looking through the syllabus for Stanford University's class, CS231n: Convolutional Neural Networks for Visual Recognition. Much of the material is familiar to me but a lot of the application is new as I have not worked extensivly on applying ML to imaging problems. Thus this morning I thought I would work through the first assignment and get the mental gears turning.</p>

<p class="article-number">4</p>
<p class="article-date">Nov. 4th 2017</p>
		...
		<article class="article-body">
			<header class="article-header">
				...
				<div class="article-title-metadata">
					...
					<p>Published Nov. 4, 2017</p>
				</div>
			</header>
			<main>
			<div class="article_content" style="text-align: left;">

				<p>In this post I wanted to kill two birds with one stone. First, to test out my method for integrating my ipython notebook work into blog posts, and second to brush a little rust off my understanding of Convolutional Neural Nets. The other day I was looking through the syllabus for Stanford University's class, CS231n: Convolutional Neural Networks for Visual Recognition. Much of the material is familiar to me but a lot of the application is new as I have not worked extensivly on applying ML to imaging problems. Thus this morning I thought I would work through the first assignment and get the mental gears turning.</p><br>

				<h3>Q1: K-Nearest Neighbor Classifier:</h3>

				<p>In this first part of assignment #1 we practice putting together a simple image classification pipeline, using a k-Nearest Neighbor classifier.</p>

				<p>In pattern recognition, the k-nearest neighbors algorithm (k-NN) is a non-parametric method used for classification and regression. In this assignment we utilize a very basic implementation to predict image labels in the CIFAR-10 Dataset.</p>
