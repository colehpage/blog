...
<p class="article-date">Aug. 22nd 2017</p>
		...
		<article class="article-body">
			<header class="article-header">
				...
				<div class="article-title-metadata">
					...
					<p>Published August 22nd, 2017</p>
				</div>
			</header>
			<main>
			<div class="article_content" style="text-align: left;">

				<p>This morning I want to test out my method for integrating ipython notebook work into blog posts while simultaniously brushing a little rust off my understanding of Convolutional Neural Nets. Lets do this by working through the first exercise in Stanford's CS231n: Convolutional Neural Networks for Visual Recognition class. Much of the material is familiar to me but a lot of the application is new as I have not worked extensivly on applying ML to imaging problems so it seems like a good way to get the gears turning!</p><br>
